...
print 'It took ' + i + ' iterations to sort the deck.';</code>
			...
			<section>
					...
					<div class="row 50% uniform">
						<div class="12u$">
							<span class="image fit"><img
								src="<c:url value="/resources/images/pic11.jpg"/>" /></span>
						</div>
						<div class="4u">
							<span class="image fit"><img
								src="<c:url value="/resources/images/pic03.jpg"/>" /></span>
						</div>
						<div class="4u">
							<span class="image fit"><img
								src="<c:url value="/resources/images/pic04.jpg"/>" /></span>
						</div>
						<div class="4u$">
							<span class="image fit"><img
								src="<c:url value="/resources/images/pic05.jpg"/>" /></span>
						</div>
						<div class="4u">
							<span class="image fit"><img
								src="<c:url value="/resources/images/pic05.jpg"/>" /></span>
				...
				<h4>Left &amp; Right</h4>
				<p>
					<span class="image left"><img src="images/pic06.jpg" alt="" /></span>Fringilla
					...
					pellentesque praesent. Donec accumsan interdum nisi, quis tincidunt
